...
contract ('Xotik', function(accounts){
	...
	it('initializes the contract with the correct values',function(){
		return Xotik.deployed().then(function(instance){
			...
			assert.equal(symbol, '$XOTIK', 'has the correct symbol');
	...
	it('transfers token ownership', function(){
		return Xotik.deployed().then(function(instance){
			...
			return tokenInstance.transfer.call(accounts[1], 99999999999999999, {from: accounts[0] });
	...
	it('approves tokens for deligated transfer', function(){
		return Xotik.deployed().then(function(instance){
			...
			assert.equal(allowance.toNumber(), 100, 'stores the allowance for deligated transfer');
		});
	});
